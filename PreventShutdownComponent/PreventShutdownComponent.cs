...
namespace PreventShutdownComponent
{
    public class PreventShutdownComponent : Component
    {
        static byte[] originalACL = null;
        ...
        public void DenyUserAccessToProcess(IntPtr hProcess)
        {
        ...
        public void DenyUserAccessToCurrentProcess()
        {
            if (originalACL != null)
                return;
            ...
            IntPtr hProcess = GetCurrentProcess();
            // Read the DACL
            DenyUserAccessToProcess(hProcess);
        }
